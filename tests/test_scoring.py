from ideas_hub.pipeline import is_signal_eligible, signal_score
...
def test_signal_opportunity_threshold_is_inclusive_at_50():
    assert not is_signal_eligible(49.99, threshold=50)
    assert is_signal_eligible(50, threshold=50)
